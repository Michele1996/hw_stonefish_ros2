            ...
            case SensorType::VISION:
            {
                switch(((VisionSensor*)sens)->getVisionSensorType())
                {
                    ...
                    case VisionSensorType::OPTICAL_FLOW_CAMERA:
                    {
                        ...
                        cam->InstallNewDataHandler(std::bind(&ROS2SimulationManager::OpticalFlowCameraImageReady, sim, std::placeholders::_1));
                    ...
                    {    
                        ...
                        cam->InstallNewDataHandler(std::bind(&ROS2SimulationManager::SegmentationCameraImageReady, sim, std::placeholders::_1));
                    ...
                    case VisionSensorType::EVENT_BASED_CAMERA:
                    {
                        ...
                        cam->InstallNewDataHandler(std::bind(&ROS2SimulationManager::EventBasedCameraOutputReady, sim, std::placeholders::_1));
                    }
                        break;
